...
export default function ServiceOrders() {
  ...
  const calculateFinalTotal = () => {
    ...
    if (paymentData.discount_type === "percentage") {
      discount = originalTotal * (paymentData.discount_value / 100);
  ...
  const confirmFinish = async () => {
    ...
    // Calcular valores finais com desconto
    ...
    if (paymentData.discount_type === "percentage") {
      discountPercent = paymentData.discount_value;
      discountAmount = (currentOrder.quote.subtotal || currentOrder.quote.total) * (paymentData.discount_value / 100);
    } else if (paymentData.discount_type === "fixed") {
      discountAmount = paymentData.discount_value;
      discountPercent = 0;
    }

    // Update quote status and payment with discount
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold">R$ {(currentOrder?.quote?.total || 0).toFixed(2)}</span>
                </div>
                {paymentData.discount_type !== "none" && (
                  <div className="flex justify-between text-red-700">
                    ...
                    <span className="font-semibold">
                      - R$ {paymentData.discount_type === "percentage" 
                        ? ((currentOrder?.quote?.total || 0) * (paymentData.discount_value / 100)).toFixed(2)
